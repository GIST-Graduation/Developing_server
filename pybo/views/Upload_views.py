...
def upload_file(request):
    if request.method == 'POST':
        ...
        graduation.author = request.user
        graduation.my_major = 3
        graduation.get_my_courses(ws)
        graduation.classify_my_course()
        graduation.save()
        ...
        for name in my_classified_course:
            if name == "major_core" or name == "major_elective":
                ...
                try:
                    ...
                    pass
        total = sum_credits()
        context = {'course_list': my_classified_courses, 'total': total, 'unclassfied_credit': my_classified_courses_credit["nonclassified_courses"]}
